...
!! Fortran-Variables Declaration
    integer :: pid, ierr, i, j, maxiter, mallocsCals
    integer :: np, ne, nt, ni, nb, nbg, ndim, nomga
    integer :: nip, nbp, nrp, ncp, nirp, nbgp, nbgcp
    integer :: nc, nr, nbgc, npceout, ncijk, nir, casep, npcein
    ...
    double precision :: const_diff, sigma, amp, NegOne, PosOne
    ...
    double precision :: tolc = 1.0d-4                           !! Coarse-solver tolerence
...
!!!---------------------------------------------------------------------------------------------
    ...
    call VecAYPX(PetVeci,NegOne,Fsi,ierr)
    call KSPSolve(kspAi,PetVeci,SolVeci,ierr)
